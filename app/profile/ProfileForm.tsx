...
const inputClass =
  'h-10 w-full rounded-lg border border-custom-border bg-custom-background-dark px-3 text-sm text-custom-text-main placeholder:text-custom-text-muted/30 outline-none focus:border-custom-primary/60 focus:ring-0 transition-colors';

const selectClass =
  'h-10 w-full rounded-lg border border-custom-border bg-custom-background-dark px-3 text-sm text-custom-text-main outline-none focus:border-custom-primary/60 transition-colors appearance-none cursor-pointer';
...
export function ProfileForm({ profile }: { profile: ProfileData }) {
  ...
  return (
    <form action={action} className="glass rounded-2xl border border-custom-border bg-custom-card-bg p-5">
      {state.message && (
        <p
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <div className="sm:col-span-2 md:col-span-3">
          ...
          <input id="name" name="name" type="text" defaultValue={profile.name}
            placeholder="Your name" className={inputClass} aria-invalid={!!state.errors?.name} />
        ...
        <div>
          ...
          <input id="age" name="age" type="number" defaultValue={profile.age}
            placeholder="e.g. 25" className={inputClass} aria-invalid={!!state.errors?.age} />
        ...
        <div>
          ...
          <input id="weight" name="weight" type="number" step="0.1"
            defaultValue={profile.weight ?? ''} placeholder="e.g. 75"
            className={inputClass} aria-invalid={!!state.errors?.weight} />
        ...
        <div>
          ...
          <input id="height" name="height" type="number" defaultValue={profile.height ?? ''}
            placeholder="e.g. 178" className={inputClass} aria-invalid={!!state.errors?.height} />
        ...
        <div>
          ...
          <select id="experience" name="experience" defaultValue={profile.experience}
            className={selectClass} aria-invalid={!!state.errors?.experience}>
        ...
        <div>
          ...
          <select id="goal" name="goal" defaultValue={profile.goal ?? ''} className={selectClass}>
