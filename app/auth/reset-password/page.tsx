...
export default function ResetPasswordPage() {
  ...
  return (
    <main className="bg-custom-page flex flex-1 flex-col p-8 text-custom-text-main">
      ...
      <section
        ...
        className="text-custom-text-muted my-6 flex flex-col items-center justify-center gap-2 text-xs"
      >
      ...
      <footer className="mt-auto mb-8 flex flex-col gap-4 text-center">
        <Button
          className="bg-custom-primary w-full rounded-full py-8 text-lg font-medium text-white"
          size="lg"
